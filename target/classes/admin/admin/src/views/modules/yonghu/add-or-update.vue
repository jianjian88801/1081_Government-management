        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="所在单位" prop="danweiTypes">
                        <el-select v-model="ruleForm.danweiTypes" :disabled="ro.danweiTypes" placeholder="请选择所在单位">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="所在单位" prop="danweiValue">
