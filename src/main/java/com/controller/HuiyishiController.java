    ...
    */
    ...
    public R save(@RequestBody HuiyishiEntity huiyishi, HttpServletRequest request){
        ...
        Wrapper<HuiyishiEntity> queryWrapper = new EntityWrapper<HuiyishiEntity>()
            ...
            .eq("huiyishi_mingcheng", huiyishi.getHuiyishiMingcheng())
        ...
        if(huiyishiEntity==null){
            huiyishi.setInsertTime(new Date());
...
//                            huiyishiEntity.setHuiyishiMingcheng(data.get(0));                    //会议室号 要改的
...
//                            huiyishiEntity.setHuiyishiSuqiuContent("");//详情和图片
//                            huiyishiEntity.setInsertTime(date);//时间
